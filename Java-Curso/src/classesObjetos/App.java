...
public class App {
    public static void main(String[] args) {
        ...
        /* Declarando um Objeto do tipo classesObjetos.Celular = Instanciando um Objeto */
        ...
        // "classesObjetos.Celular " + celularA.nome + " com tela de " + celularA.tamanhoTela + ", com %d e SO %s"
        System.out.format("classesObjetos.Celular %s com tela de %.1f, com %dgb e SO %s\n", celularA.nome, celularA.tamanhoTela, celularA.espacoArmazenamento, celularA.sistemaOperacional);
